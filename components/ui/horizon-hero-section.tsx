...
export const HorizonHeroSection: React.FC = () => {
  ...
  const smoothCameraPos = useRef<SmoothCameraPos>({ x: 0, y: 30, z: 100 });
  const cameraVelocity = useRef<CameraVelocity>({ x: 0, y: 0, z: 0 });
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      refs.stars.forEach(starField => {
        ...
        if (starField.material && 'dispose' in starField.material) {
      ...
      refs.mountains.forEach(mountain => {
        ...
        if (mountain.material && 'dispose' in mountain.material) {
      ...
      if (refs.nebula) {
        ...
        if (refs.nebula.material && 'dispose' in refs.nebula.material) {
          ...
          {[...Array(2)].map((_, i) => {
            ...
            return (
              <section key={i} className="scroll-section">
                <h2 className="section-title">{titles[i]}</h2>
                <p className="section-description">
                  {i === 0 ? 'Exploring the infinite cosmos of possibilities' : 'Beyond the horizon lies infinite potential'}
                </p>
              </section>
            );
          })}
